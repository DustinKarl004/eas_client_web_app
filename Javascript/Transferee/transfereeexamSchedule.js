...
async function fetchExamSchedule() {
    try {
        const examineesQuery = query(collection(db, 'transferee_examinees'));
                ...
                const batchHtml = `
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center" style="background-color: #fdc500; color: #000;">
                            ...
                            <a href="client_transferee_cdm_Schedule.html?batch_no=${batchNumber}" class="btn" style="background-color: #212529; color: #fff;">View</a>
                        </div>
                    </div>
                `;
